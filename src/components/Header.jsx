...
function Header() {
  ...
  const { token, clearAuth } = useAuth(); // ✅ get auth state
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            {!token ? (
              <div className="flex items-center space-x-4">
                <button
                  className="text-gray-700 hover:text-blue-600 font-medium py-2 px-4 flex items-center gap-2"
                  onClick={() => navigate('/login')}
                >
                  <User size={18} />
                  Login
              ...
              <div className="flex items-center space-x-4">
                <button
                  className="bg-red-500 hover:bg-red-600 text-white font-medium py-2 px-4 rounded-lg flex items-center gap-2"
